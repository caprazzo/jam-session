...
public final class RequestInfo {
	...
	*/
	...
	public RequestInfo(ServletContext servletContext, HttpServletRequest req,
	...
	public static RequestInfo create(ServletContext servletContext,
			HttpServletRequest req, HttpServletResponse resp,
			UserService userService) {
		return new RequestInfo(servletContext, req, resp, userService);
	}
